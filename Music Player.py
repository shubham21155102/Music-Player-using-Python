...
root=Tk()
root.title('Valentine music player')
...
playlist=Listbox(root,selectmode=SINGLE,bg="Black",fg="Yellow",font=('arial',30),width=100)
playlist.grid(columnspan=50)

os.chdir(r'D:\Py adv\1\mix music')
songs=os.listdir()
for s in songs:
